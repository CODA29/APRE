          ...
          @for(user of users; track user) {
            <tr>
              ...
              <td>
                ...
                <!--Here, the built-in title attribute is used to add a tooltip
                  to the delete icon. When the user hovers over the icon, the tooltip "Delete User" will be displayed.
                -->
